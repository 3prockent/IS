...
from behavior_algorithm import *
import time
...
background = pygame.image.load("images/gridbackground.png").convert()
coin = pygame.image.load("images/nomdot.png").convert()
coin.set_colorkey(BLACK)
cells = init_grid("images/gridbackground.png")
